  ...
  return (
    <>
      <div className="relative mt-[115px]">
        <div
          className={`lg:flex lg:px-4 ${rubik.className} place-self-center w-full`}
        >
          <div className="relative w-full h-[281px] md:rounded-[32px] overflow-hidden md:w-[586px] md:h-[385px] place-self-center">
            <Image
          ...
          <div className={`md:flex md:ml-10 relative bottom-[95px]`}>
            <div className="relative w-[325px] h-[180px] rounded-[16px]  place-self-center lg:hidden bg-[#D27722] text-white text-right">
          ...
          <div className="w-full lg:text-left lg:mt-8 place-self-center lg:w-1/2  relative bottom-[95px] ">
            <h1 className="text-[30px] font-[600] pl-12 mt-15">Other Benefits</h1>

            {benefits.map((content, index) => (
              <div key={index}>
                <div className="w-[326px] h-[260px] place-self-center border rounded-[9px] border-[#D27722] mt-4 pt-5 md:w-[738px] md:h-[122px] md:flex lg:w-full lg:h-[148px]">
                  <div className="px-4">
